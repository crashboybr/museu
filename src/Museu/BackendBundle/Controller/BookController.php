...
use Museu\BackendBundle\Entity\Book;
use Museu\BackendBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MuseuBackendBundle:Book')->findAll();

        return $this->render('MuseuBackendBundle:Book:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MuseuBackendBundle:Book:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MuseuBackendBundle:Book')->find($id);
        ...
        return $this->render('MuseuBackendBundle:Book:show.html.twig', array(
            'entity'      => $entity,
